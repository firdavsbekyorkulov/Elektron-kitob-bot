...
def start(message):
	...
	item4 = types.KeyboardButton("Bizning Botlarimiz")
...
@bot.messge_handler(content_types = ['text'])
def bot_message(message):
	if message.chat.type == 'private':
		if message.text == 'Maktab darsliklari':
			...
			item3 = types.KeyboardButton("2-sinf Alifbe")
			...
			item3 = types.KeyboardButton("3-sinf Alifbe")
			...
			item3 = types.KeyboardButton("6-sinf Alifbe")
			item4 = types.KeyboardButton("6-sinf Yozuv daftari")
			item5 = types.KeyboardButton("6-sinf Matematika daftari")
			item6 = types.KeyboardButton("6-sinf Ona tili")
			item7 = types.KeyboardButton("6-sinf Tabiiy fan")
			...
			item2 = types.KeyboardButton("8-sinf Matematika")
			item3 = types.KeyboardButton("8-sinf Alifbe")
			item4 = types.KeyboardButton("8-sinf Yozuv daftari")
			item5 = types.KeyboardButton("8-sinf Matematika daftari")
			item6 = types.KeyboardButton("8-sinf Ona tili")
			item7 = types.KeyboardButton("8-sinf Tabiiy fan")
			item8 = types.KeyboardButton("8-sinf Ingliz tili")
			item9 = types.KeyboardButton("8-sinf Tasviriy san'at")
			...
			button1 = types.KeyboardButton("1-botimiz")
			button2 = types.KeyboardButton("2-botimiz")
			button3 = types.KeyboardButton("3-botimiz")
			button4 = types.KeyboardButton("4-botimiz")
